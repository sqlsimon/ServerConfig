...
IF EXISTS (SELECT 1 FROM msdb.dbo.sysjobs WHERE name = 'Application1_Job1')
	EXEC msdb.dbo.sp_delete_job @job_name=N'Application1_Job1', @delete_unused_schedule=1


EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Application1_Job1', 
		@enabled=1, 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'Application1_Job1', 
